...
public class ClientSideEncrypter {
    ...
    private CCMBlockCipher aesCipherTest;
    ...
    public String encrypt(String plainText) throws EncrypterException {
        ...
        try {
            ...
            return String.format("%s%s%s%s%s%s", PREFIX, VERSION, SEPARATOR, Base64.toBase64String(encryptedAESKey), SEPARATOR, Base64.toBase64String(result));

            //return encryptedAESKey.toString();
        } catch (IllegalBlockSizeException e) {
